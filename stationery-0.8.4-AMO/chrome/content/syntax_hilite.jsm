...
Stationery.syntax = {
  ...
  //TODO: pass nsiEditor ??
  getClearHtml: function(html) {
    //character used to fill empty line divs, so serializer will not remove them
      ...
      hl.doWork = function() {
        while (hl.currentCharIdx < hl.sourceLen) {
          ...
          if (sourceHtml[hl.currentCharIdx] == '<') {
            ...
            //process attribs
            while(hl.currentCharIdx < hl.sourceLen) {
              if((sourceHtml[hl.currentCharIdx] == '/') || (sourceHtml[hl.currentCharIdx] == '>'))
                break;
              ...
              if(sourceHtml[hl.currentCharIdx] == '=') {
                ...
                if((sourceHtml[hl.currentCharIdx] == '"') || (sourceHtml[hl.currentCharIdx] == "'")) {
                  hl.quotedAttribValue = sourceHtml[hl.currentCharIdx];
                ...
                while(hl.currentCharIdx < hl.sourceLen) {
                  if(hl.quotedAttribValue == '' /*no quotes*/) {
                    ...
                    if (sourceHtml[hl.currentCharIdx] == hl.quotedAttribValue)
                      break;
